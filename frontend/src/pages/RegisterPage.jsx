...
import { Shield, ArrowRight, ArrowLeft, Building2, UserCircle2, MapPin, Map, Wallet, Truck } from 'lucide-react';
...
const RegisterPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:5000/api/risk-assessment', formData);
            ...
            setError('Failed to connect to the risk assessment server. Make sure the backend and AI service are running.');
            setIsSubmitting(false);
        }
    };
        ...
        <div className="min-h-[90vh] flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative bg-gray-50 overflow-hidden pt-24">
            ...
            <div className="w-full max-w-xl z-10">
                <div className="text-center mb-10">
                    <Link to="/" className="inline-flex items-center text-sm font-medium text-gray-500 hover:text-primary-600 transition-colors mb-4 bg-white/50 backdrop-blur pb-1 px-3 rounded-full border border-gray-200 py-1.5">
                    ...
                    <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Onboard to GigCover</h1>
                    <p className="mt-2 text-gray-500">
                        Tell us about your work to get a custom, AI-calculated weekly premium.
                    </p>
                </div>
                ...
                <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 sm:p-10 relative overflow-hidden">
                    ...
                    <div className="mb-8 relative">
                        ...
                        <div className="relative flex justify-between items-center z-10 mt-[-14px]">
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold shadow transition-colors duration-300 ${currentStep >= 1 ? 'bg-primary-600 text-white' : 'bg-white text-gray-400 border border-gray-200'}`}>
                                1
                            </div>
                            <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold shadow transition-colors duration-300 ${currentStep === 2 ? 'bg-accent-600 text-white' : 'bg-white text-gray-400 border border-gray-200'}`}>
                                2
                            </div>
                        </div>
                    </div>
                    ...
                    <form onSubmit={currentStep === 1 ? handleNext : handleSubmit}>
                        {currentStep === 1 && (
                            <div className="space-y-6 animate-fade-in">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500 mb-6">Enter your basic verification information.</p>
                                </div>

                                <div>
                                    <label htmlFor="name" className="block text-sm font-semibold text-gray-700 mb-2">Full Legal Name</label>
                                ...
                                <div>
                                    <label htmlFor="city" className="block text-sm font-semibold text-gray-700 mb-2">Primary City of Operation</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        ...
                        {currentStep === 2 && (
                            <div className="space-y-6 animate-fade-in">
                                <div>
                                    <h3 className="text-xl font-bold text-gray-900 mb-1">Work Profile</h3>
                                    <p className="text-sm text-gray-500 mb-6">This helps our AI assess your risk accurately.</p>
                                </div>

                                <div>
                                    <label htmlFor="platform" className="block text-sm font-semibold text-gray-700 mb-2">Delivery Platform</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                ...
                                <div>
                                    <label htmlFor="dailyIncome" className="block text-sm font-semibold text-gray-700 mb-2">Average Daily Income (INR)</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                ...
                                <div>
                                    <label htmlFor="zoneType" className="block text-sm font-semibold text-gray-700 mb-2">Working Zone Type</label>
                                    <div className="grid grid-cols-2 gap-4">
                                        <label className={`cursor-pointer border-2 rounded-xl p-4 flex flex-col items-center text-center transition-all ${formData.zoneType === 'urban' ? 'border-primary-500 bg-primary-50' : 'border-gray-100 hover:border-gray-200 bg-white'}`}>
                                            <input
                                                type="radio"
                                                name="zoneType"
                                                value="urban"
                                                ...
                                                required
                                            />
                                            <Building2 className={`w-8 h-8 mb-2 ${formData.zoneType === 'urban' ? 'text-primary-600' : 'text-gray-400'}`} />
                                            <span className={`font-semibold ${formData.zoneType === 'urban' ? 'text-primary-900' : 'text-gray-600'}`}>Urban</span>
                                            <span className="text-xs text-gray-500 mt-1">High Traffic</span>
                                        </label>

                                        <label className={`cursor-pointer border-2 rounded-xl p-4 flex flex-col items-center text-center transition-all ${formData.zoneType === 'semi-urban' ? 'border-primary-500 bg-primary-50' : 'border-gray-100 hover:border-gray-200 bg-white'}`}>
                                            <input
                                                type="radio"
                                                name="zoneType"
                                                value="semi-urban"
                                                ...
                                                required
                                            />
                                            <Map className={`w-8 h-8 mb-2 ${formData.zoneType === 'semi-urban' ? 'text-primary-600' : 'text-gray-400'}`} />
                                            <span className={`font-semibold ${formData.zoneType === 'semi-urban' ? 'text-primary-900' : 'text-gray-600'}`}>Semi-Urban</span>
                                            <span className="text-xs text-gray-500 mt-1">Med Traffic</span>
                                        </label>
                                    </div>
                                </div>
